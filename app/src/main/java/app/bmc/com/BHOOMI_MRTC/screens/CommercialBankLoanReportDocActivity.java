    ...
    private void loadURL() {
        if (!mbURLLoaded)
            ...
            if (appValue != null && custIdValue!=null &&  bankIdValue!= null) {
                webViewBankLoanReport.setWebViewClient(new WebViewClient(){
                    ...
                    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                        Toast.makeText(CommercialBankLoanReportDocActivity.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
                    }
